    ...
    <footer className="shop-footer kamatas-footer">
      <div className="shop-container footer-shop-grid">
        <div className="footer-shop-brand">
          <Link href="/">
            <span className="kamatas-footer-logo">Kamataş</span>
          </Link>
        </div>
        ...
        <div>
          ...
          <Link href="/gizlilik-ve-iade-kosullari">Kişisel Veriler Politikası</Link>
          <h3 className="footer-video-title">Kurulum ve Montaj Videoları için:</h3>
          <div className="footer-social-links">
            <a href="https://www.instagram.com/kamatasaluminyum" target="_blank" rel="noreferrer" aria-label="Instagram">
            ...
            <a href="https://www.youtube.com/@KamatasAluminyum" target="_blank" rel="noreferrer" aria-label="YouTube">
              <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
      ...
      <div className="shop-container footer-copyright">
        ©2026 Tüm Hakları Saklıdır · | | | | E-Ticaret Altyapısı ile Hazırlanmıştır.
      </div>
    </footer>
  );
}
